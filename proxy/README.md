...
- Cloudflare WAF or rate limiting is still recommended for a public endpoint.
...
3. Add provider secrets with Wrangler:
...
5. In Summarize This settings, enable **Use backend proxy for AI calls** and paste the deployed Worker URL as the proxy endpoint.
